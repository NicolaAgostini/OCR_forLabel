...
def trOCR():
    ...
    from trOCR.scripts.dataset import OCRDataset
    from trOCR.scripts.train_engine import run_fine_tuning
    from trOCR.scripts.inference import run_prediction
    from trOCR.scripts.table_extractor import extract_cell_crops
